            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <a @click="editCompany(company)" data-bs-toggle="modal" data-bs-target="#exampleModal2" class="btn btn-sm btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form >
                <div class="modal-body">
                    <div class="form-group">
                        <label><b>{{ company.name }}</b> isimli şirketi silmek istediğinizden emin misiniz?</label>
                        
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Kapat</button>
                    <a @click="deleteCompany(company)"  class="btn btn-danger" data-bs-dismiss="modal">Sil</a>
                </div>
            </form>
            </div>
        </div>
